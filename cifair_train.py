...
def main():
    ...
    if "SLURM_JOB_ID" in os.environ.keys():
        dataset1 = CIFAR10(config.dataset_path.format("cifar10"), train=True, transform=transform)
        dataset2 = CIFAR10(config.dataset_path.format("cifar10"), train=False, transform=transform)
    else:
